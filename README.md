...
Hold a key, speak, release. The audio uploads to ElevenLabs Scribe v2 Medical (batch) and the transcript lands on the clipboard. Batch-only, single speaker, medical config.
