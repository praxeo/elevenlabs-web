...
5. **Phone UI.** The big-button layout is done; surfacing the capture waveform on the big screen is the open gap (the Mic ✓/⚠ health pill landed), then a larger live readout and swipe gestures.
